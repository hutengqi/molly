 ...
 * 不启动 Spring 容器，仅验证 Word / PDF 模板可被 starter 正确处理。
 * <p>
 * 运行方式：
 * <pre>
 *   mvn -pl molly-example -am -DskipTests install
 *   cd molly-example &amp;&amp; mvn dependency:build-classpath -Dmdep.outputFile=target/cp.txt -DincludeScope=runtime
